  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn more about the mission behind My Gov Blog."
        />
        <link rel="canonical" href={`${siteUrl}/about`} />
        <meta property="og:title" content={`About Us | ${siteTitle}`} />
        <meta
          property="og:description"
          content={`Learn more about the mission behind ${siteTitle}.`}
        />
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 sm:py-16 about-page">
        ...
        <section className="space-y-6 text-base leading-relaxed text-[var(--color-muted-text)]">
          <p>
            ...
            shouldn&apos;t come with confusion, paperwork headaches, or dead
            ends.
          </p>

          <p>
            Navigating government support programs can feel overwhelming.
            Whether it&apos;s food stamps, housing assistance, low-cost
            internet, or help with medical expenses, the options are there — but
            the process isn&apos;t always clear.
          </p>
          ...
          <p>
            That&apos;s where we come in. We created this site to make
            government assistance easier to understand and more approachable.
            Our goal is to guide individuals and families through{" "}
            <em>what programs exist</em>, <em>who qualifies</em>, and{" "}
            <em>how to apply</em> — without jargon or red tape.
          </p>
