...
// Location-aware MDX tokens (no-op without provider)
import {
  City,
  State,
  IfLocation,
...
export default async function PostPage(props: {
  ...
  return (
    <>
      ...
      {/* Breadcrumbs JSON-LD (omit /posts crumb because it redirects) */}
      <JsonLd
        data={{
          "@context": "https://schema.org",
          "@type": "BreadcrumbList",
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 sm:py-16">
        <FadeIn>
          ...
          <p
            className="font-medium uppercase tracking-wide mb-6"
            style={{ color: "var(--color-muted-text)", fontSize: "0.65rem" }}
            /* Prevents hydration warnings if client/server format differ */
