...
You’ve probably heard the Affordable Connectivity Program (ACP) ran out of funding, but the Lifeline program still exists—and many carriers (like SafeLink) continue to offer free plans if you qualify. Here’s how to act fast and avoid common snags.
...
<IfLocation>
  ...
  <ResourceLink name="freePhone" field="faqs" />
</IfLocation>
